...
@Generated("https://github.com/testcontainers/testcontainers-java/blob/de1324ed2800eff4da326d0c23d281399d006bc0/core/src/main/java/org/testcontainers/utility/DockerImageName.java")
public final class DockerImageName {
    ...
    public DockerImageName withRegistry(final String registry) {
        return new DockerImageName(rawName, registry, repository, versioning, compatibleSubstituteFor);
    }
    ...
    public DockerImageName withRepository(final String repository) {
        return new DockerImageName(rawName, registry, repository, versioning, compatibleSubstituteFor);
    }
    ...
    public DockerImageName withVersioning(final Versioning versioning) {
        return new DockerImageName(rawName, registry, repository, versioning, compatibleSubstituteFor);
    }
    ...
    public DockerImageName withCompatibleSubstituteFor(final DockerImageName compatibleSubstituteFor) {
        return new DockerImageName(rawName, registry, repository, versioning, compatibleSubstituteFor);
    }
    ...
    private DockerImageName(final String rawName, final String registry, final String repository, final Versioning versioning, final DockerImageName compatibleSubstituteFor) {
    ...
    public DockerImageName(String fullImageName) {
        ...
        if (remoteName.contains("@sha256:")) {
            ...
            versioning = AnyVersion.INSTANCE;
        }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(registry, that.registry) && java.util.Objects.equals(repository, that.repository) && versioning.equals(that.versioning);
    }

    @Override
    public int hashCode() {
        return Objects.hash(registry, repository, versioning);
    }
}
