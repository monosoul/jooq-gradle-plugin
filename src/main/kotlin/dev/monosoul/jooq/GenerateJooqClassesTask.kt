...
open class GenerateJooqClassesTask
    ...
    constructor(
        ...
        val migrationLocations =
            objectFactory.listProperty<MigrationLocation>().convention(
                listOf(
         ...
         * @see Project.files
         */
        fun ListProperty<MigrationLocation>.setFromFilesystem(files: FileCollection) =
            set(
...
private data class PrivateValueHolder<T>(
